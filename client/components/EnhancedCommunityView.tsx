...
export default function EnhancedCommunityView({
  ...
  const theme =
    DOMAIN_THEMES[community.domain as keyof typeof DOMAIN_THEMES] ||
    DOMAIN_THEMES.default;
  ...
  const onlineMembers = community.onlineUsers.filter(
    (user) => user.status === "online",
  );
  const awayMembers = community.onlineUsers.filter(
            ...
            >
                          ...
                          <div className="flex-1 space-y-3">
                            ...
                            <div className="flex items-center justify-between">
                              ...
                              <Button
                                ...
                                disabled={
                                  !newPost.trim() && selectedFiles.length === 0
                                }
                              >
                              ...
                              <div className="flex items-center justify-between mb-3">
                                ...
                                <DropdownMenu>
                                  ...
                                  <DropdownMenuContent>
                                    <DropdownMenuItem
                                      onClick={() =>
                                        unpinPost(community.id, post.id)
                                      }
                                    >
                        ...
                        {community.pinnedMessages.map((message) => (
                          ...
                          >
                            ...
                            <Button
                              ...
                              size="sm"
                              onClick={() =>
                                unpinMessage(community.id, message.id)
                              }
                            >
                              <X className="w-3 h-3" />
                            </Button>
                            ...
                            <div className="opacity-0 group-hover:opacity-100 transition-opacity">
                              <DropdownMenu>
                                ...
                                <DropdownMenuContent>
                                  ...
                                  <DropdownMenuItem
                                    onClick={() =>
                                      pinMessage(community.id, message.id)
                                    }
                                  >
                                    <Pin className="w-4 h-4 mr-2" />
                                    Pin Message
              ...
              <TabsContent value="projects" className="flex-1 p-4">
                <div className="text-center py-12">
                  ...
                  <p className="text-muted-foreground mb-4">
                    Collaborate on exciting projects with community members
                  </p>
                  <Button>
              ...
              <TabsContent value="hackathons" className="flex-1 p-4">
                <div className="text-center py-12">
                  ...
                  <p className="text-muted-foreground mb-4">
                    Join exciting hackathons and win amazing prizes
                  </p>
                  <Button>
                    <Plus className="w-4 h-4 mr-2" />
                    Create Hackathon
              ...
              <TabsContent value="events" className="flex-1 p-4">
                <div className="text-center py-12">
                  ...
                  <p className="text-muted-foreground mb-4">
                    Attend workshops, meetups, and networking events
                  </p>
                  <Button>
                    <Plus className="w-4 h-4 mr-2" />
                    Create Event
