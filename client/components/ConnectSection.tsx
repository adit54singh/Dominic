...
const UserCard = memo(({ user, onFollow, onMessage, onView, isFollowed }: {
  user: User;
  ...
  const handleMessage = useCallback(() => onMessage(user.id), [onMessage, user.id]);
      ...
      <CardContent className="p-6">
        <div className="flex items-start space-x-4">
          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="text-primary font-medium text-sm mb-1">{user.title}</p>
...
const ConnectSection = memo(() => {
  ...
  const users = useMemo<User[]>(() => [
    ...
    },
    {
      ...
      studentsHelped: 178,
      responseTime: "~2 hrs",
      expertise: ["Product Strategy", "Analytics", "Agile", "User Experience"],
