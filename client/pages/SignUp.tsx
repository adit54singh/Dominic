        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
              ...
              career growth with peer-to-peer learning.
            </p>
          </div>
            ...
            <Card className="border-0 bg-background/50 backdrop-blur-sm shadow-xl">
              <CardHeader className="text-center">
                ...
                <p className="text-muted-foreground">
                  Sign up with your Google account to begin your learning
                  journey
                </p>
              </CardHeader>
            ...
            <div className="space-y-6">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">
                    Join study groups and collaborate with students from top
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">
                    Get guidance from successful professionals and senior
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">
                    Fast-track your learning with curated resources and
                    real-world projects.
                  </p>
                </div>
              </div>
