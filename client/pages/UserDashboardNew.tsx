...
export default function UserDashboard() {
  ...
  useEffect(() => {
    localStorage.setItem('joinedCommunities', JSON.stringify(Array.from(joinedCommunities)));
  }, [joinedCommunities]);
  ...
  const domainMappings = {
    "software-dev": { name: "Software Development", icon: Code, color: "bg-blue-500" },
  ...
  const userDomains = userOnboardingData?.domains?.map((domainId: string) => {
    ...
    return {
      ...
      projectsCompleted,
      mentorshipHours,
      currentProjects: userOnboardingData?.projects?.map((project: any, index: number) => ({
        name: project.name || `Project ${index + 1}`,
        description: project.description || "A collaborative project",
        skills: project.techStack ? project.techStack.split(", ") : userOnboardingData?.skills?.slice(0, 3) || [],
        collaborators: Math.floor(Math.random() * 5) + 2,
        timeLeft: index === 0 ? "2 weeks left" : "1 month left",
        type: domainId.includes('web') ? 'Frontend' : domainId.includes('mobile') ? 'Mobile' : 'Full Stack'
      })) || [{
        name: `Sample ${mapping?.name || 'Tech'} Project`,
        description: `Working on exciting ${mapping?.name?.toLowerCase() || 'technology'} solutions`,
        skills: userOnboardingData?.skills?.slice(0, 3) || ['JavaScript', 'React'],
        collaborators: 3,
  ...
  const generateProfileForDomain = () => {
    ...
    const getUserTitle = () => {
      const isTechDomain = ['software-dev', 'web-dev', 'mobile-dev', 'data-science', 'design'].includes(selectedDomain);

      if (isTechDomain) {
        if (selectedDomain === 'web-dev' || selectedDomain === 'software-dev') {
          return userOnboardingData?.experience === 'advanced' ? 'Senior Software Engineer' :
                 userOnboardingData?.experience === 'intermediate' ? 'Software Engineer' : 'Junior Developer';
        }
    ...
    return {
      ...
      experience: userOnboardingData?.experience === 'beginner' ? '< 1 Year' :
                  ...
                  userOnboardingData?.experience === 'advanced' ? '3+ Years' : '2 Years',
  ...
  const communityProfiles = [
    {
      ...
      description: "Senior developer with 5+ years of experience in building production-ready applications. Currently working on microservices architecture and leading a team of 8 developers at TechCorp.",
    ...
    },
    {
      ...
      description: "Mobile development specialist who has published 15+ apps on Play Store and App Store. Expert in cross-platform development and UI/UX design principles.",
    ...
    },
    {
      ...
      description: "AI/ML researcher with focus on computer vision and NLP. Currently working on recommendation systems that serve 50M+ users. Published researcher with 3 papers.",
    ...
    },
    {
      ...
      description: "DevOps engineer with 4+ years of experience in building scalable cloud infrastructure. Currently managing infrastructure for multiple microservices serving 10M+ users.",
      achievements: ["☁️ AWS Certified Solutions Architect", "🚀 Reduced deployment time by 80%", "⚡ 99.9% uptime achieved"],
      communities: [
        { name: "DevOps Engineers India", role: "Core Member", members: "4.5k" },
        { name: "Cloud Native Developers", role: "Technical Lead", members: "2.1k" },
        { name: "Kubernetes Community", role: "Active Contributor", members: "6.7k" }
      ],
      projects: 15,
      connections: 203,
    ...
    },
    {
      ...
      description: "Product designer with expertise in user research, interaction design, and prototyping. Led design for 3 successful product launches with 90% user satisfaction.",
      achievements: ["🎨 Designed award-winning mobile app", "📊 Improved user engagement by 65%", "👥 Led design team of 5"],
      communities: [
    ...
    },
    {
      ...
      description: "Blockchain developer specializing in Ethereum and Solidity. Built 5+ DeFi protocols with $50M+ TVL. Active contributor to open-source Web3 projects.",
      achievements: ["⛓️ Built DeFi protocol with $50M TVL", "🏆 ETHIndia hackathon winner", "📝 Published 10+ smart contracts"],
      communities: [
        { name: "Blockchain Developers India", role: "Technical Advisor", members: "5.2k" },
    ...
    },
    {
      ...
      description: "QA engineer with 5+ years of experience in manual and automated testing. Built testing frameworks that reduced testing time by 70% and improved release quality.",
      achievements: ["🧪 Automated 95% of test cases", "🐛 Found 500+ critical bugs", "⚡ Reduced testing time by 70%"],
      communities: [
        { name: "QA Engineers Network", role: "Senior Member", members: "2.8k" },
        { name: "Test Automation Guild", role: "Workshop Lead", members: "1.7k" },
    ...
    },
    {
      ...
      description: "ML engineer with expertise in deep learning, computer vision, and NLP. Deployed 10+ ML models in production serving millions of users with 95% accuracy.",
      achievements: ["🤖 Deployed 10+ ML models in production", "📊 Achieved 95% model accuracy", "🏅 Kaggle Grandmaster"],
      communities: [
        { name: "AI/ML Engineers India", role: "Research Lead", members: "6.3k" },
        { name: "Deep Learning Community", role: "Technical Writer", members: "4.7k" },
        { name: "Computer Vision Hub", role: "Project Maintainer", members: "2.9k" }
      ],
      projects: 13,
      connections: 289,
    ...
    if (activeTab === "edit-profile" || activeVerticalNav === "edit-profile") {
                      ...
                      <div className="space-y-4">
                        <div className="flex items-center gap-3 mb-3">
                          ...
                          <Badge className="bg-green-600 hover:bg-green-700">
                            ...
                            Level {getCurrentDomain().progress > 80 ? '12' : getCurrentDomain().progress > 50 ? '8' : '5'}
                          </Badge>
                        </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              <Card className="hover:shadow-lg transition-colors">
                <CardContent className="p-6 text-center">
                  <div className="text-3xl font-bold text-blue-500 mb-2">{joinedProjects.length}</div>
                  <div className="text-sm text-muted-foreground">Joined Projects</div>
                </CardContent>
              </Card>
              ...
              <Card className="hover:shadow-lg transition-colors">
                <CardContent className="p-6 text-center">
                  <div className="text-3xl font-bold text-green-500 mb-2">{followedUsers.size}</div>
              ...
              <Card className="hover:shadow-lg transition-colors">
                <CardContent className="p-6 text-center">
                  <div className="text-3xl font-bold text-purple-500 mb-2">{joinedCommunities.size}</div>
            ...
            <div className="grid lg:grid-cols-2 gap-8 mb-8">
              ...
              <Card className="transform transition-all duration-300 hover:shadow-lg hover:border-primary/20">
                ...
                <CardContent className="space-y-6">
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-3 gap-4">
                      <div className="text-center">
                        <div className="text-2xl font-bold text-green-500">{joinedProjects.length}</div>
                      ...
                      <div className="text-center">
                        ...
                        <div className="text-xs text-muted-foreground">People Following</div>
                      </div>
                      <div className="text-center">
                        <div className="text-2xl font-bold text-yellow-500">{joinedCommunities.size}</div>
                  ...
                  <div>
                    <h4 className="font-semibold mb-3 text-sm text-muted-foreground">Recent Activity</h4>
                    <div className="space-y-3">
                      {userActivity.length > 0 ? (
                        userActivity.slice(0, 5).map((activity, index) => {
                          const timeAgo = new Date(activity.timestamp).toLocaleString();
                          return (
                            <div key={activity.id} className="flex items-start gap-3 p-3 bg-muted/30 rounded-lg transition-colors hover:bg-muted/50">
                              <div className={`w-2 h-2 rounded-full mt-2 ${
                                activity.type === 'project_joined' ? 'bg-green-500' :
                                activity.type === 'community_joined' ? 'bg-blue-500' :
                                activity.type === 'community_left' ? 'bg-red-500' :
                                activity.type === 'follow' ? 'bg-purple-500' : 'bg-cyan-500'
                              }`} />
                        ...
                        <div className="text-center py-4 text-muted-foreground">
                          ...
                          <div className="text-xs mt-1">Start joining projects and communities to see your activity here!</div>
                        </div>
                      )}
                    </div>
                  </div>
                  ...
                  <div>
                    <div className="flex justify-between items-center mb-2">
                      ...
                      <span className="text-sm font-bold text-green-500">
                        {userActivity.length === 0 ? 'Getting Started' :
                         userActivity.length < 5 ? 'Active' : 'Very Active'}
                      </span>
                    </div>
                    <div className="w-full bg-muted rounded-full h-2">
                      <div
                        className="bg-gradient-to-r from-primary to-primary/60 h-2 rounded-full transition-all duration-1000"
                        style={{ width: `${Math.min((userActivity.length / 10) * 100, 100)}%` }}
                      ></div>
                    </div>
                  </div>
                </CardContent>
                ...
                <CardContent className="space-y-4">
                  {joinedProjects.length > 0 ? (
                    joinedProjects.map((project, index) => {
                      ...
                      return (
                        <div key={project.id} className={`p-4 rounded-lg border transform transition-all duration-200 hover:scale-[1.02] ${
                          priority === 'High' ? 'bg-red-500/10 border-red-500/20 hover:bg-red-500/15' :
                          priority === 'Medium' ? 'bg-yellow-500/10 border-yellow-500/20 hover:bg-yellow-500/15' :
                          ...
                          <div className="flex justify-between items-start mb-3">
                            <div className="flex-1">
                              ...
                              <div className="text-xs text-muted-foreground mb-2">
                                Due: {dueDate.toLocaleDateString()} ({daysLeft > 0 ? `${daysLeft} days left` : 'Overdue'})
                              </div>

                              {/* Skills Used */}
                              <div className="flex flex-wrap gap-1 mb-2">
                                {project.techStack?.map((skill: string, skillIndex: number) => (
                                  <Badge key={skillIndex} variant="outline" className="text-xs px-2 py-0.5 bg-primary/10 border-primary/30 text-primary">
                                    {skill}
                                  </Badge>
                                ))}
                              </div>
                    ...
                    <div className="text-center py-8 text-muted-foreground">
                      ...
                      <p className="text-sm mt-2">Join projects from the Connect or Discover sections to see them here!</p>
                    </div>
                  )}
                </CardContent>
              </Card>
                  ...
                  {[
                    {
                      ...
                      rating: 5,
                      feedback: 'Excellent frontend work and great communication. Delivered high-quality code and was very responsive to feedback.',
                      time: '2 days ago',
                    ...
                    },
                    {
                      ...
                      rating: 4,
                      feedback: 'Strong technical skills, delivered on time. Great problem-solving approach and clean code structure.',
                      time: '1 week ago',
                      role: 'Tech Lead',
                    ...
                    },
                    {
                      ...
                      rating: 5,
                      feedback: 'Outstanding problem-solving abilities and attention to detail. Excellent collaboration skills.',
                      time: '2 weeks ago',
                      role: 'Data Scientist',
                    ...
                    },
                    {
                      ...
                      rating: 5,
                      feedback: 'Innovative solutions and great teamwork. Always ready to help and share knowledge with the team.',
                      time: '3 weeks ago',
                      ...
                      <div className="flex items-start space-x-4 mb-4">
                        ...
                        <div className="flex-1">
                          <div className="flex items-center justify-between mb-1">
                            <div className="font-semibold text-sm group-hover:text-primary transition-colors">{collab.name}</div>
                            <div className="flex items-center">
                              {renderStars(collab.rating)}
                              <span className="ml-1 text-xs font-semibold text-yellow-600">{collab.rating}.0</span>
                            </div>
                          </div>
                          <div className="text-xs text-muted-foreground mb-1">{collab.role}</div>
                          <div className="text-xs font-medium text-primary">{collab.project}</div>
                        </div>
                      </div>
      ...
      return (
        <div className="space-y-6">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            <div>
              <h1 className="text-2xl sm:text-3xl font-bold">Connect with Community</h1>
              <p className="text-muted-foreground">
      ...
      return (
        <div className="space-y-6">
          <div className="text-center mb-8">
            ...
            <p className="text-muted-foreground">
              Get inspired by verified professionals sharing their journey, work culture, and collaborative projects you can join
            </p>
          </div>
          <DiscoverFeed
            selectedDomain={selectedDomain}
        ...
        <div className="space-y-6">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            <div>
              ...
              <p className="text-muted-foreground">
                Connect with like-minded learners and join active communities in your domains
              </p>
            </div>
            <div className="flex items-center space-x-2">
              <Button variant="outline" size="sm">
            ...
            <CardContent>
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
                {userDomains?.map((domain, index) => (
                  <Card key={domain.id} className="hover:shadow-lg transition-all duration-200 cursor-pointer group">
                    <CardContent className="p-4">
                      ...
                      <p className="text-xs text-muted-foreground mb-3">
                        Connect with {domain.name.toLowerCase()} enthusiasts and share knowledge
                      </p>
                  ...
                  <div className="col-span-full text-center py-8 text-muted-foreground">
                    ...
                    <p>Complete onboarding to join communities related to your domains!</p>
                  </div>
                )}
              </div>
            </CardContent>
          ...
          <Card>
            ...
            <CardContent>
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
                {[
                  { name: "AI/ML Researchers", members: "12.3k", growth: "+24%", color: "bg-purple-500", icon: Database },
                  { name: "React Developers", members: "8.7k", growth: "+18%", color: "bg-blue-500", icon: Code },
                  { name: "Content Creators", members: "6.2k", growth: "+32%", color: "bg-pink-500", icon: Camera },
                  { name: "Startup Founders", members: "4.1k", growth: "+15%", color: "bg-yellow-500", icon: Briefcase },
                  { name: "Food Bloggers", members: "3.8k", growth: "+28%", color: "bg-orange-500", icon: Utensils },
                  { name: "Travel Enthusiasts", members: "5.4k", growth: "+21%", color: "bg-emerald-500", icon: Plane }
                ].map((community, index) => (
                  <Card key={index} className="hover:shadow-lg transition-all duration-200 cursor-pointer group">
                    <CardContent className="p-4">
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <Button
                          variant={joinedCommunities.has(`trending_${index}`) ? "outline" : "ghost"}
                          size="sm"
                          className="text-xs"
                          onClick={() => {
                        ...
                        >
                          {joinedCommunities.has(`trending_${index}`) ? "Leave" : "Join"}
                        </Button>
                      </div>
                    </CardContent>
                  </Card>
                ...
                {[
                  ...
                  <div key={index} className="flex items-center justify-between p-4 bg-muted/30 rounded-lg hover:bg-muted/50 transition-colors cursor-pointer">
                    <div>
                      ...
                      <p className="text-xs text-muted-foreground">
                        {event.community} • {event.date} • {event.attendees} attending
                      </p>
                    </div>
                    <div className="flex items-center space-x-2">
                      <Badge variant="outline" className="text-xs">
        ...
        <div className="space-y-6">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              ...
              <div>
                <h1 className="text-2xl sm:text-3xl font-bold">
                  {userDomains?.find(d => d.id === viewingCommunity)?.name || "Community"} Hub
                </h1>
                <p className="text-muted-foreground">
                  Connect and collaborate with the {userDomains?.find(d => d.id === viewingCommunity)?.name.toLowerCase()} community
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="grid lg:grid-cols-4 gap-6">
                      ...
                      <div key={userId} className="flex items-center space-x-2 p-2 rounded-lg hover:bg-muted/50">
                        <Avatar className="w-8 h-8">
                          <AvatarFallback className="bg-primary text-white text-xs">
                            {userId === "1" ? "RK" : userId === "2" ? "PS" : "AP"}
                          </AvatarFallback>
                        </Avatar>
                        <div className="flex-1 min-w-0">
                          <div className="text-sm font-medium truncate">
                            {userId === "1" ? "Rajesh Kumar" : userId === "2" ? "Priya Sharma" : "Arjun Patel"}
                          </div>
                          <div className="text-xs text-muted-foreground truncate">
                            {userId === "1" ? "Full Stack Developer" : userId === "2" ? "Data Scientist" : "Mobile Developer"}
                          </div>
                        </div>
                      </div>
                    );
              ...
              <Card>
                ...
                <CardContent className="space-y-2">
                  {["React 18", "TypeScript", "Next.js", "Tailwind CSS"].map((topic, index) => (
                    <div key={index} className="text-xs text-primary hover:underline cursor-pointer p-2 rounded hover:bg-primary/5">
                      #{topic}
                    </div>
                  ))}
                </CardContent>
            ...
            <div className="lg:col-span-3">
              ...
              <Card className="mb-6">
                <CardHeader className="pb-3">
                  <CardTitle className="text-sm">Share with the community</CardTitle>
                </CardHeader>
                <CardContent>
                  ...
                  <Card>
                    <CardContent className="p-8 text-center">
                      ...
                      <p className="text-sm text-muted-foreground mb-4">
                        Be the first to share something with the {userDomains?.find(d => d.id === viewingCommunity)?.name.toLowerCase()} community!
                      </p>
                      <Button onClick={() => {
                        const welcomePost = {
                          id: Date.now().toString(),
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="hidden lg:flex items-center space-x-6">
              ...
              <button
                ...
                className={`flex items-center space-x-2 px-3 py-2 rounded-lg transition-colors ${
                  activeTab === "discover" ? "bg-primary/10 text-primary" : "text-muted-foreground hover:text-foreground"
                }`}
              >
              ...
              {viewingCommunity && (
                <button
                  ...
                  className={`flex items-center space-x-2 px-3 py-2 rounded-lg transition-colors ${
                    activeTab === "community-hub" ? "bg-primary/10 text-primary" : "text-muted-foreground hover:text-foreground"
                  }`}
                >
                  <Users className="w-4 h-4" />
                  <span>{userDomains?.find(d => d.id === viewingCommunity)?.name || "Community"} Hub</span>
                </button>
              )}
            </div>
                    ...
                    <div className="p-4 border-b border-primary/10">
                      <div className="flex items-center space-x-3">
                        ...
                        <div>
                          ...
                          {userOnboardingData && (
                            <div className="text-xs text-primary mt-1">
                              {userOnboardingData.experience} • {userOnboardingData.domains?.length || 0} domains
                            </div>
                          )}
                        </div>
                      </div>
                  ...
                  <div className="grid grid-cols-1 gap-2">
                    {userDomains?.map((domain) => (
                          ...
                          <div>
                            ...
                            {userOnboardingData && (
                              <div className="text-xs text-muted-foreground mt-1">
                                {userOnboardingData.experience ? `${userOnboardingData.experience} level` : ''}
                                {userOnboardingData.leetcodeRank && ` • LeetCode: ${userOnboardingData.leetcodeRank}`}
                                {userOnboardingData.gfgRank && ` • GFG: ${userOnboardingData.gfgRank}`}
                              </div>
                            )}
                          </div>
                        </div>
                      ...
                      <div className="text-center text-muted-foreground p-4">
                        <p className="text-sm">Complete onboarding to see your domains</p>
                      </div>
                    )}
                  </div>
                </div>
                ...
                <div className="border-t pt-4">
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    ...
                    <button
                      ...
                      className={`flex items-center space-x-2 p-3 rounded-lg transition-colors ${
                        activeTab === "discover" ? "bg-primary/10 text-primary" : "hover:bg-muted"
                      }`}
                    >
                      <Search className="w-4 h-4" />
                    ...
                    <button
                      ...
                      className={`flex items-center space-x-2 p-3 rounded-lg transition-colors ${
                        activeTab === "community" ? "bg-primary/10 text-primary" : "hover:bg-muted"
                      }`}
                    >
                      <Users className="w-4 h-4" />
                    ...
                    {viewingCommunity && (
                      <button
                        ...
                        className={`flex items-center space-x-2 p-3 rounded-lg transition-colors ${
                          activeTab === "community-hub" ? "bg-primary/10 text-primary" : "hover:bg-muted"
                        }`}
                      >
                        <Users className="w-4 h-4" />
                        <span className="text-sm">{userDomains?.find(d => d.id === viewingCommunity)?.name || "Community"} Hub</span>
                      </button>
                    )}
