          ...
          <div className="grid lg:grid-cols-4 gap-6">
            ...
            <div className="lg:col-span-1 space-y-6">
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="text-xs text-muted-foreground leading-relaxed">
                    {user.bio
                      ...
                      : `Passionate ${getCurrentDomain().name.toLowerCase()} enthusiast looking to connect with peers and collaborate on exciting projects.`}
                  </div>
              ...
              <div>
                ...
                <ProfileCard
                  profile={generateProfileForDomain()}
                  className="w-full"
                />
              </div>
            </div>
                            ...
                            onClick={() => {
                              ...
                              addActivity({
                                ...
                                action: isFollowing
                                  ...
                                  : `Started following ${profile.name}`,
